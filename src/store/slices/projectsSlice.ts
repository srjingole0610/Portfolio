...
const initialState: ProjectsState = {
  projects: [
    ...
    },
    {
      ...
      liveUrl: 'https://app.netlify.com/teams/srjingole0610/overview',
      featured: true,
    },
    {
      id: '3',
    ...
    },
    {
      ...
      description: 'A dynamic financial dashboard built with Angular and Node.js, providing real-time data visualization and financial reporting for enterprise clients.',
