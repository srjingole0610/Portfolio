...
const initialState: ProjectsState = {
  projects: [
    ...
    },
    {
      ...
      description: 'A responsive and intuitive todo list application built with JavaScript that helps users organize their tasks. Features include adding, deleting, and marking tasks as complete.',
    ...
    },
    {
      ...
      technologies: ['JavaScript', 'HTML', 'CSS'],
      imageUrl: 'https://images.unsplash.com/photo-1611032605663-61027bd35b49?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80',
